...
The "phase window" (e.g., `04:50 - 05:50`) represents the **CBTmin window** (core body temperature minimum), the mathematical anchor of the Forger99 model. CBTmin typically occurs 2-3 hours _before_ natural wake time.
